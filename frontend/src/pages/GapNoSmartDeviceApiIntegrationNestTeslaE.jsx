...
export default function GapNoSmartDeviceApiIntegrationNestTeslaE() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-smart-device-api-integration-nest-tesla-e', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No smart device API integration (Nest, Tesla, Ecobee, SmartThings)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISmartHomeEnergyOptimizer - Gap feature</p>
