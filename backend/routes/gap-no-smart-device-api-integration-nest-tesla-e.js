...
const FEATURE_SLUG = 'no-smart-device-api-integration-nest-tesla-e';
const FEATURE_TITLE = 'No smart device API integration (Nest, Tesla, Ecobee, SmartThings)';
const PROJECT = 'AISmartHomeEnergyOptimizer';
